function ExperienceCard() {
  return (
    <div className="group p-4 col-span-1 md:col-span-2 md:row-span-1 space-y-2 rounded-md border bg-accent/40">
      ...
      <div className="relative space-y-4 mt-4">
        ...
        <div className="relative pl-6 group/role">
          ...
          <div className="space-y-1">
            <h3 className="text-sm font-bold">Software Developer</h3>
